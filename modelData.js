...
const comment1 = {
  ...
  comment:
    "Learning new programming languages is hard... it's so easy to forget a </div>!",
  user: jo,
  photo_id: photo1._id,
};
const comment2 = {
  ...
  comment:
    "This is another comment, with a bit more text; if the text gets long enough, does it wrap properly from line to line?",
  user: jo,
  photo_id: photo1._id,
};
const comment3 = {
  ...
  comment:
    "If you see this text in <b>boldface</b> then HTML escaping isn't working properly.",
  user: jo,
  photo_id: photo1._id,
};
const comment4 = {
...
// CommonJS export (dùng cho server.js)
module.exports = {
  userListModel,
  userModel,
  photoOfUserModel,
